...
* [Edgeware Smart Contracts](quickstart/edgeware-smart-contracts/README.md)
  * [Deploy a WASM Contract](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/README.md)
    * [Setup Environment](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/setup-environment.md)
    * [Creating an ink! Project](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/creating-an-ink-project.md)
    * [Building Your Contract](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/building-your-contract.md)
    * [Running an Edgeware Node](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/running-an-edgeware-node.md)
    * [Deploying Your Contract](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/deploying-your-contract.md)
    * [Calling Your Contract](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/calling-your-contract.md)
    * [Live Smart Contracts](quickstart/edgeware-smart-contracts/deploy-a-wasm-contract/live-smart-contracts.md)
  * [WASM Basics](quickstart/edgeware-smart-contracts/wasm-basics/README.md)
    * [Contract Template](quickstart/edgeware-smart-contracts/wasm-basics/contract-template/README.md)
      * [Storing a Value](quickstart/edgeware-smart-contracts/wasm-basics/contract-template/storing-a-value.md)
      * [Getting a Value](quickstart/edgeware-smart-contracts/wasm-basics/contract-template/getting-a-value.md)
      * [Incrementing the Value](quickstart/edgeware-smart-contracts/wasm-basics/contract-template/incrementing-the-value.md)
      * [Storing a Mapping](quickstart/edgeware-smart-contracts/wasm-basics/contract-template/storing-a-mapping.md)
      * [Incrementing My Value](quickstart/edgeware-smart-contracts/wasm-basics/contract-template/incrementing-my-value.md)
  * [Deploy an EVM Contract](quickstart/edgeware-smart-contracts/deploy-an-evm-contract/README.md)
    * [Setting up a Edgeware EVM node](quickstart/edgeware-smart-contracts/deploy-an-evm-contract/setting-up-a-edgeware-evm-node.md)
    * [Using Metamask](quickstart/edgeware-smart-contracts/deploy-an-evm-contract/using-metamask.md)
    * [Using Remix - Ethereum IDE](quickstart/edgeware-smart-contracts/deploy-an-evm-contract/using-remix-ethereum-ide.md)
    * [Using Truffle](quickstart/edgeware-smart-contracts/deploy-an-evm-contract/using-truffle.md)
    * [Using Web3](quickstart/edgeware-smart-contracts/deploy-an-evm-contract/using-web3.md)
    * [EVM Resources](quickstart/edgeware-smart-contracts/deploy-an-evm-contract/edgeware-evm-resources.md)
  * [WASM Advanced](quickstart/edgeware-smart-contracts/wasm-advanced.md)
  * [WASM Ballot Contract](quickstart/edgeware-smart-contracts/wasm-ballot-contract.md)
