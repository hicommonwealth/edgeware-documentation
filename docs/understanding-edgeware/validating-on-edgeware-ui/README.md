...
Go to the [polkadot-js web interface](https://polkadot.js.org/apps/#/settings) and connect to a custom node, e.g. berlin1.edgewa.re, berlin2.edgewa.re, or berlin3.edgewa.re.
